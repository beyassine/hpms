...
class Planification(models.Model):
	criticite=(('c1','C1'),('c2','C2'),('c3','C3'))
	periodicite_choices=(('Hebdomadaire','Hebdomadaire'),('Mensuelle','Mensuelle'),('Trimestrielle','Trimestrielle'),('Semestrielle','Semestrielle'),('Annuelle','Annuelle'))
	...
	datecreated=models.DateTimeField(default=timezone.now)
	#Périodicité
	periodicite=models.CharField(max_length=100,choices=periodicite_choices,verbose_name='Periodicité')
	#Dates Planification
	datedebut=models.DateTimeField(default=timezone.now,verbose_name='Date Début Planification')
	datefin=models.DateTimeField(default=timezone.now,verbose_name='Date Fin Planification')
